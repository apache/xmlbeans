...
// TODO -- I'm importing my own nodes through DOM methods!  -- make this faster
    ...
    static abstract class CharNode implements Dom, Node, CharacterData
    {
        ...
        public Node appendChild ( Node newChild ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_appendChild( this, newChild ); }
        public Node cloneNode ( boolean deep ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_cloneNode( this, deep ); }
        public NamedNodeMap getAttributes ( ) { throw new RuntimeException( "not impl" ); } //return null; }
        public NodeList getChildNodes ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._emptyNodeList; }
        public Node getParentNode ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getParentNode( this ); }
        public Node removeChild ( Node oldChild ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_removeChild( this, oldChild ); }
        public Node getFirstChild ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getFirstChild( this ); }
        public Node getLastChild ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getLastChild( this ); }
        public String getLocalName ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getLocalName( this ); }
        public String getNamespaceURI ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getNamespaceURI( this ); }
        public Node getNextSibling ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getNextSibling( this ); }
        public String getNodeName ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getNodeName( this ); }
        public short getNodeType ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getNodeType( this ); }
        public String getNodeValue ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getNodeValue( this ); }
        public Document getOwnerDocument ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getOwnerDocument( this ); }
        public String getPrefix ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getPrefix( this ); }
        public Node getPreviousSibling ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_getPreviousSibling( this ); }
        public boolean hasAttributes ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_hasAttributes( this ); }
        public boolean hasChildNodes ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_hasChildNodes( this ); }
        public Node insertBefore ( Node newChild, Node refChild ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_insertBefore( this, newChild, refChild ); }
        public boolean isSupported ( String feature, String version ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_isSupported( this, feature, version ); }
        public void normalize ( ) { throw new RuntimeException( "not impl" ); } //DomImpl._node_normalize( this ); }
        public Node replaceChild ( Node newChild, Node oldChild ) { throw new RuntimeException( "not impl" ); } //return DomImpl._node_replaceChild( this, newChild, oldChild ); }
        public void setNodeValue ( String nodeValue ) { throw new RuntimeException( "not impl" ); } //DomImpl._node_setNodeValue( this, nodeValue ); }
        public void setPrefix ( String prefix ) { throw new RuntimeException( "not impl" ); } //DomImpl._node_setPrefix( this, prefix ); }

        public void appendData ( String arg ) { throw new RuntimeException( "not impl" ); } //DomImpl._characterData_appendData( this, arg ); }
        public void deleteData ( int offset, int count ) { throw new RuntimeException( "not impl" ); } //DomImpl._characterData_deleteData( this, offset, count ); }
        public String getData ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._characterData_getData( this ); }
        public int getLength ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._characterData_getLength( this ); }
        public void insertData ( int offset, String arg ) { throw new RuntimeException( "not impl" ); } //DomImpl._characterData_insertData( this, offset, arg ); }
        public void replaceData ( int offset, int count, String arg ) { throw new RuntimeException( "not impl" ); } //DomImpl._characterData_replaceData( this, offset, count, arg ); }
        public void setData ( String data ) { throw new RuntimeException( "not impl" ); } //DomImpl._characterData_setData( this, data ); }
        public String substringData ( int offset, int count ) { throw new RuntimeException( "not impl" ); } //return DomImpl._characterData_substringData( this, offset, count ); }
    ...
    static class TextNode extends CharNode implements Text
    {
        ...
        public Text splitText ( int offset ) { throw new RuntimeException( "not impl" ); } //return DomImpl._text_splitText ( this, offset ); }
    }
    ...
    static class SaajTextNode extends TextNode implements javax.xml.soap.Text
    {
        ...
        public void detachNode ( ) { throw new RuntimeException( "not impl" ); } //DomImpl._soapNode_detachNode( this ); }
        public void recycleNode ( ) { throw new RuntimeException( "not impl" ); } //DomImpl._soapNode_recycleNode( this ); }
        public String getValue ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._soapNode_getValue( this ); }
        public void setValue ( String value ) { throw new RuntimeException( "not impl" ); } //DomImpl._soapNode_setValue( this, value ); }
        public SOAPElement getParentElement ( ) { throw new RuntimeException( "not impl" ); } //return DomImpl._soapNode_getParentElement( this ); }
        public void setParentElement ( SOAPElement p ) { throw new RuntimeException( "not impl" ); } //DomImpl._soapNode_setParentElement( this, p ); }
    }
