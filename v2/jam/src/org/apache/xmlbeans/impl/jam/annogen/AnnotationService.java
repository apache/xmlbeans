...
public interface AnnotationService {
  ...
  public Object getAnnotation(Class annotationType, ElementId id);

  /**
   * This is a stopgap measure.  Ultimately, we'd like a more natural
   * integration with the JAM 'types' API.  This method just lets us use them
   * together without having to touch anything over there for now.
   */
