...
public class JiraRegression50_100Test extends JiraTestBase
{
    ...
    */
    ...
    void test_jira_xmlbeans54() {
        ...
        try {
            ...
            Assertions.fail("test_jira_xmlbeans54() - out of Heap Memory");
        }
    }
     ...
     */
    @Test
    void test_jira_XmlBeans56() throws Exception {
        ...
        if (!config.validate(xmOpts)) {
            Assertions.fail("Config File did not validate - Error: " + errorList);
        }
    }
     ...
     */
    @Test
    void test_jira_XmlBeans57() throws Exception {
    ...
    */
    @Test
    @Disabled("the url doesn't exist anymore ...")
    public void test_jira_xmlbeans58() throws Exception {
        ...
        if (hasSevereError(errors)) {
            Assertions.fail("test_jira_xmlbeans55() : Errors found when executing scomp");
        }
     ...
     */
    @Test
    void test_jira_XmlBeans62() throws Exception {
        String P = File.separator;
        ...
        assertTrue(warningPresent, "Warning for 1999 schema was not found when compiling srcs");
    }
     ...
     */
    @Test
    void test_jira_XmlBeans64() throws Exception {
        // load the document
     ...
     */
    @Test
    void test_jira_XmlBeans66() throws Exception {
        ...
        assertTrue((elVal != null), "Element is null or not found");
     ...
     */
    @Test
    void test_jira_XmlBeans68() throws Exception {
     ...
     */
    @Test
    void test_jira_XmlBeans71() throws Exception {
     ...
     */
    @Test
    void test_jira_xmlbeans78() throws Exception {
     ...
     */
    @Test
    void test_jira_xmlbeans80() throws Exception {
     ...
     */
    @Test
    void test_jira_xmlbeans81() throws Exception {
     ...
     */
    @Test
    void test_jira_XmlBeans84() throws Exception {
    ...
    */
    @Disabled
    @Test
    void test_jira_xmlbeans88() throws Exception {
        List<XmlError> errors = new ArrayList<>();
        Parameters params = new Parameters();
        ...
        try {
            ...
            Assertions.fail("test_jira_xmlbeans88(): Out Of Memory Error");
        } catch (Throwable t) {
            t.getMessage();
        ...
        if (hasSevereError(errors)) {
            Assertions.fail("test_jira_xmlbeans88() : Errors found when executing scomp");
        }
    }
    ...
    */
    ...
    public void test_jira_xmlbeans96() throws Exception {
        ...
        assertEquals("1.0", props.getVersion(), "test_jira_xmlbeans96() : Xml Version is not picked up");
        assertEquals("UTF-8", props.getEncoding(), "test_jira_xmlbeans96() : Xml Encoding is not picked up");
    ...
    public void test_jira_xmlbeans98() throws Exception {
        ...
        assertEquals(0, no.getPrefix().compareTo("s"), "Expected Prefix was not present: " + no.getPrefix());
     ...
     */
    @Test
    void test_jira_xmlbeans99_a() throws Exception {
        //typed verification
    ...
    */
    ...
    void test_jira_xmlbeans99_b() {
        ...
        try {
            ...
            Assertions.fail("test_jira_xmlbeans99() : Null Pointer Exception when create Dom Node");
        } catch (Exception e) {
            Assertions.fail("test_jira_xmlbeans99() : Exception when create Dom Node");
        }
    }
    ...
    public static class XPathThread extends TestThread
    {
        ...
        public void runStatusXPath()
        {
            try {
                ...
                assertEquals(4, resSet.length, resSet.length + "");
